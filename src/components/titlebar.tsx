                ...
                <div className="flex items-center justify-between h-16">
                    ...
                    <div className="flex items-center gap-2">
                        <SlideIn direction="left" delay={0.3}>
                            <div className="flex items-center gap-1">
                                {/* Quick Create (only when signed in) */}
                                {isSignedIn && (
                                ...
                                {/* Notifications (only when signed in and not on auth pages) */}
                                {isSignedIn && !(pathname?.startsWith('/auth')) && <NotificationsBell />}
                                ...
                                {/* User Menu (only when signed in) or Sign In */}
                                {isSignedIn ? (
                                    ...
                                    <div className="ml-2">
                                        <Link href="/auth/signin" className="btn btn-primary btn-sm rounded-xl">
                                            Sign in
                                        </Link>
                                    </div>
                                )}

...
export default function SignUpPage() {
    ...
    async function handleCreateOrg(e: React.FormEvent) {
        ...
        setOrgError(null);
        try {
            const org = await createOrganization?.({ name: orgName, slug: orgSlug || undefined });
            if (org && setActive) {
                        ...
                        {isSignedIn && orgLoaded && !organization && (
                            <div className="mt-6">
                                ...
                                <form onSubmit={handleCreateOrg} className="space-y-4">
                                    ...
                                    <div className="fieldset">
                                        <label className="label" htmlFor="org-slug">Workspace slug</label>
                                        <input
                                            id="org-slug"
                                            className="input w-full"
                                            placeholder="acme"
                                        ...
                                        />
                                        <div className="text-xs text-base-content/60">Optional; we’ll generate one if empty.</div>
                                    </div>

...
export function mountChatWidget(payload) {
    ...
    switch(icon) {
        ...
        case 'message':
          ...
          break;
        default:
          iconSvg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 956.64 755.1" style="width:24px;height:24px;fill:currentColor;transition:transform 0.3s ease;">
    ...
    const bubble = el('div',
      ...
      `cursor:pointer;z-index:999999;transition:all .2s ease;padding:16px;`
    );

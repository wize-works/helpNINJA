...
const AUTH_EMAIL = process.env.SCREENSHOT_EMAIL || 'youremail@example.com';
const AUTH_PASSWORD = process.env.SCREENSHOT_PASSWORD || 'yourpassword';
...
async function captureScreenshots() {
  ...
  try {
    ...
    if (loginSuccess) {
      ...
      console.log('\n📸 Capturing authenticated dashboard screenshots...');
      ...
      // Capture responsive screenshots (authenticated)
